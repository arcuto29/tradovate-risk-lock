...
export const EndSession: React.FC<{ onEnded: () => void }> = ({ onEnded }) => {
    ...
    return (
      <div className="relative rounded-xl p-5 overflow-hidden card-premium animate-reveal">
        <div className="relative z-10 text-center py-3">
          ...
          <p className="text-white/30 text-xs">Good discipline. See you next session.</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="relative rounded-xl p-5 overflow-hidden card-premium animate-reveal">
        ...
        <div className="relative z-10">
          <p className="text-sm text-white/50 mb-4 text-center">End your current trading session?</p>
          <p className="text-[0.6rem] text-white/25 mb-4 text-center">This unlocks your settings immediately. No cooldown. No penalty.</p>
  ...
  return (
    ...
    >
      ...
      <p className="text-[0.6rem] text-white/15 mt-2 group-hover:text-white/25 transition-all text-center">Done for the day? Unlock without penalty.</p>
    </button>
  );
};
