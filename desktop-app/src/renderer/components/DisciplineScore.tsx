            ...
            <svg width="200" height="200" className="absolute inset-0 transform -rotate-90">
              ...
              <defs>
                <linearGradient id="disciplineGrad" x1="0%" y1="0%" x2="100%" y2="0%">
                  <stop offset="0%" stopColor={theme === 'nebula' ? '#22d3ee' : theme === 'aurora' ? '#10b981' : theme === 'midnight' ? '#ef4444' : theme === 'hologram' ? '#00d4ff' : theme === 'void' ? '#00ff88' : theme === 'gold' ? '#ffd700' : theme === 'neon' ? '#f472b6' : theme === 'frost' ? '#94a3b8' : '#22d3ee'} />
                  <stop offset="50%" stopColor={theme === 'nebula' ? '#a78bfa' : theme === 'aurora' ? '#06b6d4' : theme === 'midnight' ? '#ffffff' : theme === 'hologram' ? '#0066ff' : theme === 'void' ? '#00ff88' : theme === 'gold' ? '#ffffff' : theme === 'neon' ? '#a855f7' : theme === 'frost' ? '#60a5fa' : '#a78bfa'} />
                  <stop offset="100%" stopColor={theme === 'nebula' ? '#818cf8' : theme === 'aurora' ? '#34d399' : theme === 'midnight' ? '#3b82f6' : theme === 'hologram' ? '#00d4ff' : theme === 'void' ? '#00cc6a' : theme === 'gold' ? '#b8860b' : theme === 'neon' ? '#ec4899' : theme === 'frost' ? '#cbd5e1' : '#818cf8'} />
                </linearGradient>
              </defs>
              {/* Background track */}
