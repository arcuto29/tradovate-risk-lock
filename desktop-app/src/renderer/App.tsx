    ...
    <div className="app-container">
      <header className="app-header">
        ...
        <nav className="app-nav">
          ...
          >
            {lockState?.isLocked ? 'Status' : 'Risk Lock'}
          </button>
          <button
          ...
          <button
            className={currentPage === 'position' ? 'active' : ''}
            onClick={() => setCurrentPage('position')}
          >
            Size Limits
          </button>
          <button
            className={currentPage === 'coach' ? 'active' : ''}
            onClick={() => setCurrentPage('coach')}
          >
            Coach
          </button>
          <button
            className={currentPage === 'log' ? 'active' : ''}
      ...
      <footer className="app-footer">
        <p className="disclaimer">
          This application adds a behavioral barrier. It does not replace your broker's risk management.
        </p>
        <p className="brand">Trading Guardian</p>
      </footer>
    </div>
  );
};
